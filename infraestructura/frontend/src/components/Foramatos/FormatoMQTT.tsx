...
const FormatoMQTT = ({ isOpen, onClose }: FormatModalProps) => {
    const [copied, setCopied] = useState(false);
    
    const formatExample = "temperatura=30|humedad=140|V.Viento=45|presion=1013|luminosidad=850|";
                ...
                <div className="space-y-3 sm:space-y-4">
                    <div>
                        ...
                        <p className="text-gray-300 text-xs sm:text-sm mb-3">
                            Los datos deben enviarse en el formato: <code className="bg-gray-700 px-1 rounded text-xs">variable=valor|variable=valor|...</code>
                        </p>
                    </div>
                    
                    <div>
                        <h4 className="text-white font-medium mb-2 text-sm sm:text-base">Ejemplo:</h4>
                    ...
                    <div>
                        ...
                        <ul className="text-gray-300 text-xs sm:text-sm space-y-1 list-disc list-inside">
                            <li>Separar cada variable con el símbolo <code className="bg-gray-700 px-1 rounded text-xs">|</code></li>
                            <li>Usar el formato <code className="bg-gray-700 px-1 rounded text-xs">nombre=valor</code> para cada variable</li>
                            <li>No usar espacios alrededor del símbolo <code className="bg-gray-700 px-1 rounded text-xs">=</code></li>
                            <li>Los nombres de variables pueden contener letras, números y puntos</li>
                            <li>Terminar con <code className="bg-gray-700 px-1 rounded text-xs">|</code> al final</li>
                        </ul>
                    </div>
